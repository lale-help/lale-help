class Circle::OrganizersController < ApplicationController
  ...
  def index
    ...
    working_group_organizers = User.
      ...
      where(working_group_roles: { role_type: WorkingGroup::Role::LEADERSHIP_TYPES_IDS, working_group_id: current_circle.working_groups }).
      group('users.id')
