...
RSpec.describe WorkingGroupsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all working_groups as @working_groups" do
      working_group = WorkingGroup.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested working_group as @working_group" do
      working_group = WorkingGroup.create! valid_attributes
      get :show, {:id => working_group.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested working_group as @working_group" do
      working_group = WorkingGroup.create! valid_attributes
      get :edit, {:id => working_group.to_param}, valid_session
      expect(assigns(:working_group)).to eq(working_group)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new WorkingGroup" do
        expect {
          post :create, {:working_group => valid_attributes}, valid_session
      ...
      it "redirects to the created working_group" do
        post :create, {:working_group => valid_attributes}, valid_session
        expect(response).to redirect_to(WorkingGroup.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved working_group as @working_group" do
        post :create, {:working_group => invalid_attributes}, valid_session
        expect(assigns(:working_group)).to be_a_new(WorkingGroup)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested working_group" do
        working_group = WorkingGroup.create! valid_attributes
        put :update, {:id => working_group.to_param, :working_group => new_attributes}, valid_session
      ...
      it "assigns the requested working_group as @working_group" do
        working_group = WorkingGroup.create! valid_attributes
        put :update, {:id => working_group.to_param, :working_group => valid_attributes}, valid_session
        expect(assigns(:working_group)).to eq(working_group)
      end
      ...
      it "redirects to the working_group" do
        working_group = WorkingGroup.create! valid_attributes
        put :update, {:id => working_group.to_param, :working_group => valid_attributes}, valid_session
        expect(response).to redirect_to(working_group)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the working_group as @working_group" do
        working_group = WorkingGroup.create! valid_attributes
        put :update, {:id => working_group.to_param, :working_group => invalid_attributes}, valid_session
        expect(assigns(:working_group)).to eq(working_group)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested working_group" do
      working_group = WorkingGroup.create! valid_attributes
      expect {
        delete :destroy, {:id => working_group.to_param}, valid_session
      }.to change(WorkingGroup, :count).by(-1)
    end
    ...
    it "redirects to the working_groups list" do
      working_group = WorkingGroup.create! valid_attributes
      delete :destroy, {:id => working_group.to_param}, valid_session
      expect(response).to redirect_to(working_groups_url)
    end
  end
